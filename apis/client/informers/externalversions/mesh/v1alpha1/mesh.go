	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MeshV1alpha1().Meshes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MeshV1alpha1().Meshes(namespace).Watch(context.TODO(), options)
			},
		},
		&meshv1alpha1.Mesh{},
		resyncPeriod,
...
func (f *meshInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&meshv1alpha1.Mesh{}, f.defaultInformer)
}
