...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("meshdeployments"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Mesh().V1alpha1().MeshDeployments().Informer()}, nil
