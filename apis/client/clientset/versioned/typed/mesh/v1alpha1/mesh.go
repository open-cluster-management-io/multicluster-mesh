...
func newMeshes(c *MeshV1alpha1Client, namespace string) *meshes {
	return &meshes{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *meshes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Mesh, err error) {
...
func (c *meshes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MeshList, err error) {
...
func (c *meshes) Create(ctx context.Context, mesh *v1alpha1.Mesh, opts v1.CreateOptions) (result *v1alpha1.Mesh, err error) {
	result = &v1alpha1.Mesh{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("meshes").
...
func (c *meshes) Update(ctx context.Context, mesh *v1alpha1.Mesh, opts v1.UpdateOptions) (result *v1alpha1.Mesh, err error) {
	result = &v1alpha1.Mesh{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("meshes").
...
func (c *meshes) UpdateStatus(ctx context.Context, mesh *v1alpha1.Mesh, opts v1.UpdateOptions) (result *v1alpha1.Mesh, err error) {
	result = &v1alpha1.Mesh{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("meshes").
...
func (c *meshes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Mesh, err error) {
	result = &v1alpha1.Mesh{}
